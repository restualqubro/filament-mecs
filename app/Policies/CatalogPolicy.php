...
class CatalogPolicy
{
    ...
    {
        return $user->can('force_delete_service::catalog');
    }
    ...
    {
        return $user->can('force_delete_any_service::catalog');
    }
    ...
    {
        return $user->can('restore_service::catalog');
    }
    ...
    {
        return $user->can('restore_any_service::catalog');
    }
    ...
    {
        return $user->can('replicate_service::catalog');
    }
    ...
    {
        return $user->can('reorder_service::catalog');
    }
}
