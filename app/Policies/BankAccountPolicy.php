...
class BankAccountPolicy
{
    ...
    {
        return $user->can('force_delete_finance::bank::account');
    }
    ...
    {
        return $user->can('force_delete_any_finance::bank::account');
    }
    ...
    {
        return $user->can('restore_finance::bank::account');
    }
    ...
    {
        return $user->can('restore_any_finance::bank::account');
    }
    ...
    {
        return $user->can('replicate_finance::bank::account');
    }
    ...
    {
        return $user->can('reorder_finance::bank::account');
    }
}
