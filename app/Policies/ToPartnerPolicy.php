...
class ToPartnerPolicy
{
    ...
    {
        return $user->can('force_delete_any_services::service::topartner');
    }
    ...
    {
        return $user->can('restore_any_services::service::topartner');
    }
    ...
    {
        return $user->can('reorder_services::service::topartner');
    }
}
