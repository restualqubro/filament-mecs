...
use App\Models\transaksi\Pemasukan;
use App\Models\User;
...
class PemasukanPolicy
{
    ...
    {
        return $user->can('force_delete_pemasukan');
    }
    ...
    {
        return $user->can('force_delete_any_pemasukan');
    }
    ...
    {
        return $user->can('restore_pemasukan');
    }
    ...
    {
        return $user->can('restore_any_pemasukan');
    }
    ...
    {
        return $user->can('replicate_pemasukan');
    }
    ...
    {
        return $user->can('reorder_pemasukan');
    }
}
